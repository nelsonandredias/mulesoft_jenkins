		...
		stage('publish snapshot') {
            ...
            steps {
				script {
					...
					sh "mvn clean install deploy -Drevision=2.0." + ${buildnumber} + "0-SNAPSHOT -Pexchange -DanypointUsername=${ANYPOINT_USER} -DanypointPassword=${ANYPOINT_PASS} --settings ${MULE_SETTINGS}"
					echo logSeparator
				}
